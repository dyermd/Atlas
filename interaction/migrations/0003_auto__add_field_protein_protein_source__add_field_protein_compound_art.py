...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Protein_Protein.source'
        db.add_column(u'interaction_protein_protein', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['source.Source']),
                      keep_default=False)

        # Adding field 'Protein_Compound.article'
        db.add_column(u'interaction_protein_compound', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['article.Article']),
                      keep_default=False)

        # Adding field 'Compound_Compound.article'
        db.add_column(u'interaction_compound_compound', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['article.Article']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Protein_Protein.source'
        db.delete_column(u'interaction_protein_protein', 'source_id')

        # Deleting field 'Protein_Compound.article'
        db.delete_column(u'interaction_protein_compound', 'article_id')

        # Deleting field 'Compound_Compound.article'
        db.delete_column(u'interaction_compound_compound', 'article_id')
